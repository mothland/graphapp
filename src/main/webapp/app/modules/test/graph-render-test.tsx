...
import { renderGraphDynamic } from 'app/shared/graph';
...
export const GraphRenderTest = () => {
  ...
  useEffect(() => {
    ...
    renderGraphDynamic(svgRef.current, graphData, CANVAS_WIDTH, CANVAS_HEIGHT);
  }, [graphData]);

  return (
    <Card className="shadow">
      <CardHeader>Graph Renderer Test (Oldest Graph)</CardHeader>
      <CardBody>
        {loading && (
