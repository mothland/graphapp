...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './node.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_NODE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_NODE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_NODE actions', async () => {
      const arg = { id: 2800 };
    ...
    it('dispatches UPDATE_NODE actions', async () => {
      const arg = { id: 2800 };
    ...
    it('dispatches PARTIAL_UPDATE_NODE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_NODE actions', async () => {
      const arg = 42666;
