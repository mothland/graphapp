...
import { deleteEntity, getEntity } from './node.reducer';
...
export const NodeDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(nodeEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="graphappApp.node.delete.question">Are you sure you want to delete Node {nodeEntity.id}?</ModalBody>
      <ModalFooter>
