...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './graph.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRAPH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRAPH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRAPH actions', async () => {
      const arg = { id: 27322 };
    ...
    it('dispatches UPDATE_GRAPH actions', async () => {
      const arg = { id: 27322 };
    ...
    it('dispatches PARTIAL_UPDATE_GRAPH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRAPH actions', async () => {
      const arg = 42666;
