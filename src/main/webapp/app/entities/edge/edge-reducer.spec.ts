...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './edge.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EDGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EDGE actions', async () => {
      const arg = { id: 7903 };
    ...
    it('dispatches UPDATE_EDGE actions', async () => {
      const arg = { id: 7903 };
    ...
    it('dispatches PARTIAL_UPDATE_EDGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EDGE actions', async () => {
      const arg = 42666;
