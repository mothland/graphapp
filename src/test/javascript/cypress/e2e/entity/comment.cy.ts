...
describe('Comment e2e test', () => {
  ...
  const commentSample = { content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=' };
  ...
  describe('new Comment page', () => {
    ...
    it('should create an instance of Comment', () => {
      ...
      cy.get(`[data-cy="createdAt"]`).type('2026-01-13T07:52');
      cy.get(`[data-cy="createdAt"]`).blur();
      cy.get(`[data-cy="createdAt"]`).should('have.value', '2026-01-13T07:52');
